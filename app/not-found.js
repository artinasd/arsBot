    ...
    <div className="min-h-screen bg-[#f7f8fb] text-[#11131a]">
      ...
      <main className="flex min-h-[70vh] items-center justify-center px-6 pt-[76px] text-center">
        <div>
          ...
          <Link href="/" className="mt-8 inline-flex rounded-full bg-[#11131a] px-6 py-3.5 text-sm font-bold text-white transition hover:bg-[#3158e8] focus:outline-none focus:ring-4 focus:ring-[#3158e8]/20">بازگشت به خانه</Link>
        </div>
      </main>
      <Footer />
    </div>
